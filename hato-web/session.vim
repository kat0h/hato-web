...
inoremap <silent> <C-J> u<NL>
inoremap <silent> <C-M> u
inoremap <silent> <C-U> u
inoremap <silent> <C-W> u
map! <D-v> *
nnoremap <silent>  :bn
nnoremap <silent>  :bp
tnoremap <silent>  :call ToggleTerm()
nnoremap <silent>  :call ToggleTerm()
...
nnoremap <silent>  :set nohlsearch!
...
nnoremap <Plug>(molder-home) :call molder#home()
nnoremap <Plug>(molder-reload) :call molder#reload()
nnoremap <Plug>(molder-up) :call molder#up()
nnoremap <Plug>(molder-open) :call molder#open()
...
nnoremap <Plug>(lsp-previous-reference) :call lsp#internal#highlight_references#jump(-1)
nnoremap <Plug>(lsp-next-reference) :call lsp#internal#highlight_references#jump(+1)
...
nnoremap <Plug>(lsp-code-lens) :call lsp#ui#vim#code_lens()
nnoremap <Plug>(lsp-code-action) :call lsp#ui#vim#code_action()
nmap <silent> <Plug>CommentaryUndo :echoerr "Change your <Plug>CommentaryUndo map to <Plug>Commentary<Plug>Commentary"
tnoremap <silent> <C-T> :call ToggleTerm()
nnoremap <silent> <C-T> :call ToggleTerm()
nnoremap <silent> <Down> j
nnoremap <silent> <Up> j
...
set mouse=a
set pumheight=12
set runtimepath=~/.cache/dein/repos/github.com/Shougo/dein.vim,~/.vim,/usr/local/share/vim/vimfiles,~/.cache/dein,~/.cache/dein/repos/github.com/mattn/emmet-vim,~/.cache/dein/repos/github.com/alvan/vim-closetag,~/.cache/dein/.cache/.vimrc/.dein,/usr/local/share/vim/vim82,~/.cache/dein/.cache/.vimrc/.dein/after,/usr/local/share/vim/vimfiles/after,~/.vim/after,~/.vim/./dein/repos/github.com/Shougo/dein.vim
set shiftround
set shiftwidth=4
...
silent only
silent tabonly
cd ~/dev/project/hato-web/hato-web
...
%argdel
$argadd src
edit ~/dev/project/hato-web/hato-web/src/components/tabArticle/tabHomeArticle.vue
...
wincmd w
argglobal
if bufexists("src/components/tabArticle/tabStampArticle.vue") | buffer src/components/tabArticle/tabStampArticle.vue | else | edit src/components/tabArticle/tabStampArticle.vue | endif
let s:cpo_save=&cpo
set cpo&vim
inoremap <buffer> <silent> <M-n> :call AutoPairsJump()a
inoremap <buffer> <silent> <expr> <M-p> AutoPairsToggle()
...
wincmd w
argglobal
if bufexists("~/dev/project/hato-web/hato-web/src/components/tabUIComp.vue") | buffer ~/dev/project/hato-web/hato-web/src/components/tabUIComp.vue | else | edit ~/dev/project/hato-web/hato-web/src/components/tabUIComp.vue | endif
let s:cpo_save=&cpo
set cpo&vim
inoremap <buffer> <silent> <M-n> :call AutoPairsJump()a
inoremap <buffer> <silent> <expr> <M-p> AutoPairsToggle()
...
exe '3resize ' . ((&lines * 18 + 25) / 51)
tabnext 1
badd +1 ~/dev/project/hato-web/hato-web/src/components/tabArticle/tabHomeArticle.vue
badd +1 ~/dev/project/hato-web/hato-web/src/components/tabUIComp.vue
badd +1 src/components/tabArticle/tabStampArticle.vue
